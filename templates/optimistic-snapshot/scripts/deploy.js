...
const DEFAULTS = {
  ...
  disputableVoting: {
    ...
    submitter: '0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF', // Any Entity
    challenger: '0xFFfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF', // Ditto
  },
  tokenManager: {
    name: 'Test Token',
    symbol: 'TST',
    holders: ['0x5790dB5E4D9e868BB86F5280926b9838758234DD'],
    stakes: ['10000000000000000000'],
  },
}
...
module.exports = async function deploy(network) {
  ...
  const Template = artifacts.require('SnapshotTemplate')
  ...
  const {
    tokenManager: { name, symbol, holders, stakes },
  } = config
  ...
  await template.installApps(submitter, challenger, executionDelay, [
    feeToken,
    challengeDuration,
    actionCollateral,
    challengeCollateral,
