...
import "./lib/apps/DisputableDelay.sol";
...
contract BaseTemplate is IsContract {
    ...
    // App ID for disputable-delay.open.aragonpm.eth
    bytes32 constant private DISPUTABLE_DELAY_APP_ID = 0x770ca1460333b5cf9399ad6cec51fe75652c4de94e54bd50297a06c85445175e;
    ...
    */
    ...
    function _installDisputableDelayApp(Kernel _dao, uint64 _executionDelay) internal returns (DisputableDelay) {
        bytes memory initializeData = abi.encodeWithSelector(DisputableDelay(0).initialize.selector, _executionDelay);
        return DisputableDelay(_installNonDefaultApp(_dao, DISPUTABLE_DELAY_APP_ID, initializeData));
    }
    ...
    function _createDisputableDelayPermissions(
        ACL _acl,
